...
const usersSchema = {
  ...
  required: ["accountId", "projectId", "email"],
...
const submittalsSchema = {
  ...
  properties: {
    ...
    submitterDueDate: { type: "string", format: "date-time" },
...
const modelDataSchema = {
  ...
  properties: {
    ...
    plannedConstructionStartDate: { type: "string", format: "date-time" },
    plannedConstructionEndDate: { type: "string", format: "date-time" },
    realConstructionStartDate: { type: "string", format: "date-time" },
    realConstructionEndDate: { type: "string", format: "date-time" },
